                        ...
                        <div className="row align-items-center">
                            ...
                            <div className="col-12 col-md-7 col-lg-6">
                                <div className="home-intro">
                                    ...
                                    <p className="text-white my-4">블록체인 기반 계모임 플렛폼 Aramagyeddon에서 당신의 안전한 계모임을 생성하고 사람들을
                                        모아보세요 변경 불가능한 장부를 자동으로 생성하여 여러분의 곗돈을 안전하게 지켜드립니다.</p>
                ...
                <div className="container">
                    <div className="card-deck mb-3 text-center">
                        <div className="card mb-4 shadow-sm">
                            ...
                            <button type="button" className="btn btn-lg btn-block btn-outline-primary"
                                    onClick="location.href='/gyejoining' ">자세히
                            </button>
                        </div>
                    </div>
                    ...
                    <div className="card mb-4 shadow-sm">
                        ...
                        <div className="card-body">
                            ...
                            <button type="button" className="btn btn-lg btn-block btn-primary"
                                    onClick="location.href='/gyecreation' ">+
                            </button>
                        </div>
                    ...
                    <div className="card mb-4 shadow-sm">
                        ...
                        <div className="card-body">
                            ...
                            <button type="button" className="btn btn-lg btn-block btn-primary"
                                    onClick="location.href='/gyefinder' ">구경하기
                            </button>
                        </div>
                        <form action="/gye/search" method={"get"}>
                            <div class="search">
                        ...
                        <div className="row justify-content-between align-items-center">
                            <div className="col-12 col-lg-6 ">
                                ...
                                <ul className="list-unstyled">
                                    <li><p>Fully layered dolor sit amet, consectetur adipisicing elit. Facere, nobis, id
                                        expedita dolores officiis laboriosam.</p></li>
                                    <li><p>Fully layered dolor sit amet, consectetur adipisicing elit. Facere, nobis, id
                                        expedita dolores officiis laboriosam.</p></li>
                                    <li><p>Fully layered dolor sit amet, consectetur adipisicing elit. Facere, nobis, id
                                        expedita dolores officiis laboriosam.</p></li>
                    ...
                    <div className="container">
                        <div className="row justify-content-between align-items-center">
                            ...
                            <div className="col-12 col-lg-6 ">
                                ...
                                <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Similique dolor ut iusto
                                    vitae autem neque eum ipsam, impedit asperiores vel cumque laborum dicta repellendus
                                    inventore voluptatibus et explicabo nobis unde.
                                </p>
                                <ul>
                                    <li><p>Fully layered dolor sit amet, consectetur adipisicing elit. Facere, nobis, id
                                        expedita dolores officiis laboriosam.</p></li>
